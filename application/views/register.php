	...
	<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-lg-4 col-lg-offset-4">
		...
		<?php $attributes = array('role' => 'form', 'class' => 'login'); echo form_open('user/register_user', $attributes); ?>	
			<div class="form-group">
				...
				<?php $attributes = array('name' => 'username', 'placeholder' => 'Enter Username', 'class' => 'form-control'); echo form_input($attributes); ?>	
			</div>
			<div class="form-group">
				<span class="glyphicon glyphicon-lock" aria-hidden="true"></span>
				<?php $attributes = array('name' => 'password', 'placeholder' => 'Enter Password', 'class' => 'form-control'); echo form_password($attributes); ?>	
			</div>
			<div class="form-group">
				<span class="glyphicon glyphicon-lock" aria-hidden="true"></span>
				<?php $attributes = array('name' => 'repassword', 'placeholder' => 'Re-Type Password', 'class' => 'form-control'); echo form_password($attributes); ?>	
			</div>
			<div class="row">
				<div class="col-xs-12 col-xs-offset-6 col-sm-12 col-sm-offset-7 col-md-12 col-lg-5 col-lg-offset-7">
					<?php $attributes = array('class' => 'btn btn-default', 'id' => 'btn-register', 'value' => 'Register'); echo form_submit($attributes); ?>			
				</div>
			</div>
		<?php echo form_close(); ?>
	</div>	
